...
| Comprobación del correcto funcionamento del primer sitio web| **2 puntos**|
| Configuración correcta y comprobación del funcionamento de una segunda web | **1 puntos**|
